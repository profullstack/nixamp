...
test("the MCP server introduces itself and lists its tools", async () => {
  ...
  assert.deepEqual(
    ...
    ["profile_get", "profile_set", "transcribe_audio", "transcript_read", "trollbox_read", "trollbox_say", "voices_list", "watch_parties_list", "watch_party_end", "watch_party_get", "watch_party_host", "watch_party_sync"],
  );
