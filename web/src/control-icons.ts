/** Shared icon set for player, playlist, directory and admin controls. */
export type ControlIconName = keyof typeof CONTROL_ICONS;
export const CONTROL_ICONS: Record<"play" | "link" | "copy" | "restart" | "remove" | "rename" | "check" | "live" | "party" | "eye" | "gear", string> = {
...
export function drawControlIcon(button: HTMLElement, name: ControlIconName): void {
  button.innerHTML = CONTROL_ICONS[name];
}
